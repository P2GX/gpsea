...
class TestVepFunctionalAnnotator:
    ...
    def test_annotate(
        self,
        suox_variant_coordinates: VariantCoordinates,
    ...
    @pytest.mark.parametrize(
        "contig_name, start, end, ref, alt, chlen, mane_tx_id,exp_protein_id, exp_protein_start, exp_protein_end",
        [
