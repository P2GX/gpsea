...
class TestDeVriesScorer:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [intrauterine_growth_retardation, small_for_gestational_age],
                2,
            ),  # superfluous, still should be 2
            (
                [
            ...
            (
                [seizure, arachnodactyly],
                0,
            ),  # Unrelated
            (
                [intrauterine_growth_retardation, intellectual_disability_mild],
                3,
            ),
            (
                [intrauterine_growth_retardation, intellectual_disability_profound],
                4,
            ),
            (
                [intrauterine_growth_retardation, intellectual_disability_profound, microcephaly],
                5,
            ),
            (
            ...
            (
                [
                    ...
                    hypertelorism,
                    posteriorly_rotated_ears,
                    underdeveloped_crus_of_the_helix,
                ],
                8,
            ),
            (
